// api/limparHistoricoAbrangencia.js
// Zera data/historicoAbrangencia.json (histórico de importações da
// Abrangência). Não mexe nos dados em si (abrangenciaAtual.csv /
// abrangenciaAnterior.csv e seus metadados). Mesmo padrão de
// api/limparHistoricoImportacao.js (Score) — exige ADMIN_TOKEN por ser uma
// operação destrutiva.
...
export default async function handler(req, res) {
  ...
  try {
    await commitArquivo({
      ...
      caminho: 'data/historicoAbrangencia.json',
