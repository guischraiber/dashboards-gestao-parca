// api/limparHistoricoSla.js
// Zera data/historicoSla.json (histórico de importações do CSV bruto
// principal do SLA). Não mexe no CSV em si (data/slaBruto.csv).
// Mesmo padrão de api/limparHistoricoImportacao.js (Score) e
// api/limparHistoricoColetaRecebimento.js — exige ADMIN_TOKEN por ser uma
// operação destrutiva.
...
export default async function handler(req, res) {
  ...
  try {
    await commitArquivo({
      ...
      caminho: 'data/historicoSla.json',
