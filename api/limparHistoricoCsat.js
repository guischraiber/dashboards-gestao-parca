// api/limparHistoricoCsat.js
// Zera data/historicoCsat.json (histórico de importações do CSAT). Não mexe
// nos dados em si (csatRespostas.csv / csatDisparos.csv). Mesmo padrão de
...
export default async function handler(req, res) {
  ...
  try {
    await commitArquivo({
      ...
      caminho: 'data/historicoCsat.json',
