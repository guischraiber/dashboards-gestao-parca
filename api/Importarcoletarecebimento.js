// api/importarColetaRecebimento.js
// Recebe o CSV "Faturamentos Analítico" enviado pela aba "Coleta x Recebimento"
// (dentro do Performance Coleta) e salva no repositório do GitHub (pasta
// /data), disparando um redeploy automático — mesmo mecanismo de
// api/importar.js (Score).
//
...
//
// Sem exigência de ADMIN_TOKEN — mesmo padrão de api/importar.js: quem acessa
// o dashboard já pode importar direto.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Registra a importação no histórico (mesmo padrão do Score).
    try {
